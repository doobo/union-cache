...
public class ZipUtils {
	...
	public static String gzip(String primStr) {
		...
		//log.info("压缩前占用空间："+primStr.getBytes().length);
		...
		//log.info("压缩后占用空间："+gzipStr.getBytes().length);
		return gzipStr;
	}
	...
	public static final String zip(String str) {
		...
		log.info("压缩前占用空间："+str.getBytes().length);
		byte[] compressed;
		...
		log.info("压缩后占用空间："+compressedStr.getBytes().length);
